...
namespace SmileGame
{
    ...
    public class RotationAction : ActionTween
    {
        ...
        public RotModle mRotModle = RotModle.Fast;
        ...
        /// <returns></returns>
        public RotationAction SetRotModle(RotModle modle)
        {
            mRotModle = modle;
            return this;
        }
