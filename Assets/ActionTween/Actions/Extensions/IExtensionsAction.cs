...
namespace SmileGame
{
    public static class IExtensionsAction
    {
        ...
        /// <returns></returns>
        public static ActionTween RotationTween(this Transform target, Vector3 targetRot, float duration, RotationAction.RotModle modle = RotationAction.RotModle.Fast)
        {
        ...
        /// <param name="duration"></param>
        /// <returns></returns>
        public static ActionTween RotationTween(this Transform target, Transform targetTran, float duration, RotationAction.RotModle modle = RotationAction.RotModle.Fast)
        {
            var rotAction = new RotationAction();
            rotAction.SetRotModle(modle);
            rotAction.mActionType = ActionEnum.ActionType.None;
