...
public class ExampleAction_Fade : ExampleRunTest
{
    public FadeAction.FadeType mFadeType;
    public float mTargetAlphe;
    ...
    public void ColorToTest()
    {
        mTestActionTween = this.transform.FadeTween(mTargetAlphe, mDuration, mFadeType);
        mTestActionTween
            .SetEase(mEaseType)
