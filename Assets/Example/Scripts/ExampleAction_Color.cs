...
public class ExampleAction_Color : ExampleRunTest
{
    public ColorAction.ColorType mColType;
    public Color mTargetCol;
    ...
    {
        mTestActionTween = this.transform.ColorTween(mTargetCol, mDuration, mColType);
        mTestActionTween
            .SetEase(mEaseType)
